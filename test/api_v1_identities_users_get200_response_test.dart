...
// tests for ApiV1IdentitiesUsersGet200Response
void main() {
  final instance = ApiV1IdentitiesUsersGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(ApiV1IdentitiesUsersGet200Response, () {
    // BuiltList<User> content
    test('to test the property `content`', () async {
      // TODO
    });

    // ApiV1IdentitiesUsersGet200ResponsePageable pageable
    ...
    // ApiV1IdentitiesUsersGet200ResponsePageableSort sort
