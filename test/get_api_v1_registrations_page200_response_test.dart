...
// tests for GetApiV1RegistrationsPage200Response
void main() {
  final instance = GetApiV1RegistrationsPage200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetApiV1RegistrationsPage200Response, () {
    // BuiltList<Registration> content
    test('to test the property `content`', () async {
      // TODO
    });

    // ApiV1EventsGet200ResponsePageable pageable
    ...
    // ApiV1EventsGet200ResponsePageableSort sort
