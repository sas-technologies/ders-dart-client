...
class SurveysAPISurveyApi {

  final Dio _dio;

  final Serializers _serializers;

  const SurveysAPISurveyApi(this._dio, this._serializers);
  ...
  Future<Response<Survey>> deleteApiV1SurveysSurveyId({ 
    ...
    final _path = r'/api/v1/surveys/{surveyId}'.replaceAll('{' r'surveyId' '}', surveyId.toString());
  ...
  /// Returns a [Future] containing a [Response] with a [Survey] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Survey>> getApiV1SurveyById({ 
    required String surveyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetApiV1Surveys200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<GetApiV1Surveys200Response>> getApiV1Surveys({ 
    ...
    GetApiV1Surveys200Response _responseData;

    try {
      const _responseType = FullType(GetApiV1Surveys200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as GetApiV1Surveys200Response;
    ...
    return Response<GetApiV1Surveys200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Survey] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Survey>> patchApiV1SurveysSurveyId({ 
    required String surveyId,
    ...
    try {
      const _type = FullType(SurveyUpdateRequest);
      _bodyData = surveyUpdateRequest == null ? null : _serializers.serialize(surveyUpdateRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Survey] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Survey>> postApiV1Surveys({ 
    ...
    try {
      const _type = FullType(SurveyCreateRequest);
      _bodyData = surveyCreateRequest == null ? null : _serializers.serialize(surveyCreateRequest, specifiedType: _type);
