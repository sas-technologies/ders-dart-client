...
class IdentitiesUsersApi {
  ...
  /// * [email] - A string which has to be part of the emails of the returned users.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1IdentitiesUsersGet200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApiV1IdentitiesUsersGet200Response>> apiV1IdentitiesUsersGet({ 
    int? page,
    int? size,
    String? roles,
    String? userUids,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (userUids != null) r'userUids': encodeQueryParameter(_serializers, userUids, const FullType(String)),
    ...
    ApiV1IdentitiesUsersGet200Response _responseData;

    try {
      const _responseType = FullType(ApiV1IdentitiesUsersGet200Response);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ApiV1IdentitiesUsersGet200Response;
    ...
    return Response<ApiV1IdentitiesUsersGet200Response>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> apiV1IdentitiesUsersIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> apiV1IdentitiesUsersIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> apiV1IdentitiesUsersIdPasswordPut({ 
    required String id,
    ...
    final _path = r'/api/v1/identities/users/{id}/password'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
