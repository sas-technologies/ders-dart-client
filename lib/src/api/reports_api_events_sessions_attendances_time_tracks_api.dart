...
class ReportsAPIEventsSessionsAttendancesTimeTracksApi {

  final Dio _dio;

  final Serializers _serializers;

  const ReportsAPIEventsSessionsAttendancesTimeTracksApi(this._dio, this._serializers);
  ...
  Future<Response<Uint8List>> getApiV1ReportsSessionAttendancesTimeTracks({ 
    ...
    final _path = r'/api/v1/reports/events/{eventId}/sessions/attendances/time-tracks'.replaceAll('{' r'eventId' '}', eventId.toString());
