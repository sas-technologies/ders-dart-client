...
class ReportsAPIEventsSessionsAttendancesApi {

  final Dio _dio;

  final Serializers _serializers;

  const ReportsAPIEventsSessionsAttendancesApi(this._dio, this._serializers);
  ...
  Future<Response<Uint8List>> getApiV1ReportsSessionAttendances({ 
    ...
    final _path = r'/api/v1/reports/events/{eventId}/sessions/attendances'.replaceAll('{' r'eventId' '}', eventId.toString());
